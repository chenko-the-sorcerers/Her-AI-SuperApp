...
/* ═══ HerAI ML Hypothesis — AI Lab port ═══ */
...
/* ── Init ──────────────────────────────── */
window.initAiLabMlHypothesis = function() {
  var content = document.getElementById('mlhypothesis-content');
  if (!content || content.dataset.ready) return;
  content.dataset.ready = 'true';
  if (typeof drawInputSpace === 'function') drawInputSpace();
};

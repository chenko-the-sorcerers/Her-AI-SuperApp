...
/* ═══ HerAI Bias-Variance — AI Lab port ═══ */
...
/* ── Init ──────────────────────────────── */
window.initAiLabMlBiasVariance = function() {
  var content = document.getElementById('biasvariance-content');
  if (!content || content.dataset.ready) return;
  content.dataset.ready = 'true';
  if (typeof drawDartboards === 'function') drawDartboards();
  if (typeof drawPolyCanvas === 'function') drawPolyCanvas();
  if (typeof drawDecompCanvas === 'function') drawDecompCanvas();
};

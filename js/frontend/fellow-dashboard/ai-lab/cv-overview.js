(function() {
  ...
  window.initCvOverview = function() {
    ...
    // TOC scroll-spy (CV uses .module class)
    ...
    const tocFill = document.getElementById('cvTocProgressFill');
    const tocPct = document.getElementById('cvTocProgressPct');

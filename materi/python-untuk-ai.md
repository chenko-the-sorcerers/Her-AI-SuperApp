# Snapshot Runtime Pemrograman Python untuk AI

Sumber final: `materi/baru/Pengembangan Materi Pemrograman Python untuk AI- Baru.md`

Struktur runtime terbaru: 13 chapter dinamis di folder `02-python-untuk-ai/chapters/`.

# **\\Kurikulum Komprehensif Pemrograman Python untuk Artificial Intelligence: Panduan Naratif dan Praktis HerAI Fellowship**

## **Deskripsi Submodul**

Submodul pemrograman ini dirancang khusus untuk menjembatani kesenjangan antara pemahaman konseptual kecerdasan buatan dan implementasi teknis nyata bagi peserta program HerAI Fellowship. Transisi dari teori dasar ke penulisan baris kode sering kali menjadi batu sandungan utama bagi pemula, terutama bagi mereka yang belum pernah memiliki latar belakang ilmu komputer. Oleh karena itu, modul ini mengambil pendekatan berbasis naratif-pedagogis yang menyusun setiap konsep secara bertahap, menghindari lompatan logika yang terlalu jauh, dan meletakkan dasar pemikiran komputasional yang kuat sebelum peserta diperkenalkan pada pustaka data science yang lebih kompleks.
Python dipilih sebagai bahasa pengantar tunggal dalam kurikulum ini bukan hanya karena popularitasnya, melainkan karena karakteristik arsitekturalnya yang sangat mendukung pembelajaran pemula sekaligus kebutuhan industri kecerdasan buatan modern. Berdasarkan dokumentasi resmi Python, bahasa ini menawarkan sintaksis yang bersih, elegan, dan minim gangguan visual, sehingga pembelajar dapat fokus pada logika pemecahan masalah tanpa harus terbebani oleh sintaksis yang rumit seperti alokasi memori manual atau deklarasi tipe data yang kaku. Python mendukung paradigma pemrograman berorientasi objek, fungsional, dan imperatif secara fleksibel, menjadikannya sarana yang ideal untuk mengekspresikan algoritma kecerdasan buatan secara intuitif.
Lebih jauh lagi, Python bertindak sebagai bahasa kontrol yang sangat efisien dalam ekosistem kecerdasan buatan. Proses komputasi intensif dalam kecerdasan buatan, seperti perkalian matriks dimensi tinggi pada jaringan saraf tiruan, sebagian besar diimplementasikan menggunakan bahasa tingkat rendah yang cepat seperti C atau C++.1 Python menyediakan lapisan abstraksi tingkat tinggi di atas komputasi tingkat rendah tersebut, memungkinkan para praktisi kecerdasan buatan untuk mengendalikan proses kalkulasi matematis yang berat dengan kode yang mudah ditulis dan dibaca. Dengan demikian, Python menggabungkan kemudahan pengembangan aplikasi dengan kecepatan eksekusi mesin komputasi modern.
Fokus utama dari kurikulum ini adalah membangun kesiapan peserta dalam mengolah data. Sebelum melangkah ke topik-topik tingkat lanjut seperti pembelajaran mesin, pemrosesan bahasa alami, atau visi komputer, seorang praktisi kecerdasan buatan harus menguasai bagaimana data disimpan, diakses, dimanipulasi, dan disalurkan melalui alur program. Oleh karena itu, modul ini secara sengaja membatasi diri dari pembahasan model-model kecerdasan buatan yang terlalu rumit, dan memusatkan energi pengajaran pada struktur data dasar, logika percabangan, perulangan, fungsi, penanganan kesalahan, interaksi berkas, serta dasar-dasar manipulasi matriks dan tabel menggunakan NumPy dan Pandas.
...
* Menjelaskan signifikansi peran Python sebagai bahasa kontrol utama dalam ekosistem kecerdasan buatan dan analisis data.
* Mengonfigurasi lingkungan pengembangan lokal yang mandiri menggunakan Visual Studio Code, terminal, dan lingkungan virtual untuk mengisolasi dependensi proyek.
...
* Merancang alur kontrol keputusan menggunakan logika percabangan untuk menangani berbagai kondisi operasional.
* Mengotomatisasi tugas-tugas berulang dengan menerapkan perulangan pada berbagai struktur data.
* Menyusun fungsi yang modular, dapat digunakan kembali, dan bersih dengan parameterisasi serta nilai kembalian yang jelas.
* Menerapkan ekspresi Lambda dan generator sederhana untuk pemrosesan aliran data yang efisien dan hemat memori.
* Menjelaskan konsep dasar Pemrograman Berorientasi Objek seperti kelas, objek, konstruktor, dan pewarisan sifat.
* Mengimplementasikan mekanisme penanganan kesalahan menggunakan blok try-except untuk membangun aplikasi yang tangguh.
* Melakukan operasi baca-tulis berkas pada format teks dan CSV secara aman menggunakan manajer konteks.
* Membuat, memanipulasi, dan melakukan operasi matematika dasar pada array multi-dimensi menggunakan pustaka NumPy.
* Membaca dataset eksternal, melakukan inspeksi awal, dan memfilter data tabular sederhana menggunakan DataFrame Pandas.

## **Prasyarat Peserta**

Submodul ini dirancang tanpa mengasumsikan adanya latar belakang atau pengalaman menulis kode sebelumnya dari peserta. Siapa pun yang memiliki kemampuan dasar untuk mengoperasikan komputer, seperti membuka aplikasi, mengetik menggunakan papan ketik, mengelola direktori berkas, dan mengakses internet, memenuhi syarat untuk memulai materi ini. Kurikulum ini disusun secara inklusif untuk menyambut pemula mutlak.
Meskipun demikian, terdapat prasyarat kognitif yang sangat penting, yaitu kesiapan mental untuk melatih cara berpikir komputasional. Pemrograman menuntut presisi tingkat tinggi karena komputer mengeksekusi instruksi secara harfiah dan tidak memiliki kemampuan untuk menebak maksud terselubung dari penulis kode. Peserta harus siap untuk menghadapi kesalahan sintaksis, memahami pesan eror sebagai petunjuk perbaikan, serta memiliki ketekunan untuk melakukan eksperimen berulang kali.
Dari sisi perangkat lunak, peserta diwajibkan untuk mempersiapkan komputer atau laptop dengan sistem operasi modern (Windows, macOS, atau Linux) yang telah terpasang Python versi 3.10 atau yang lebih baru, editor teks Visual Studio Code beserta ekstensi Python resmi, serta akses ke terminal atau command prompt bawaan sistem operasi.
...
| **Interpreter Python** | Versi 3.10 atau lebih tinggi (64-bit) | Menerjemahkan dan mengeksekusi instruksi kode Python. |
| **Editor Kode** | Visual Studio Code (VS Code) terbaru | Menulis, mengedit, dan mengelola berkas kode. |
| **Ekstensi VS Code** | Paket Ekstensi Python (oleh Microsoft) | Menyediakan fitur penyorotan sintaksis, autolengkap, dan debugging. |
...
Peserta memahami kedudukan Python dalam ekosistem kecerdasan buatan, alasan di balik popularitasnya, cara kerja eksekusi kodenya, serta batasan-batasan penggunaan bahasa ini.

##### **Konsep Utama**

Python adalah bahasa pemrograman tingkat tinggi yang bersifat *interpreted* (diterjemahkan baris demi baris saat dijalankan) dan bertipe dinamis. Python menonjol karena keterbacaan kodenya yang luar biasa dan dukungan komunitas yang masif di bidang sains data dan kecerdasan buatan.

##### **Analogi**

Bayangkan Python sebagai seorang **Sutradara Film**.1 Sang sutradara tidak membawa kamera berat, tidak mengatur lampu secara langsung, dan tidak menjahit kostum aktor. Namun, ia memberikan instruksi yang jelas kepada para ahli di bidangnya agar bekerja secara sinergis. Dalam kecerdasan buatan, Python mengarahkan modul komputasi berkinerja tinggi (yang ditulis dalam C/C++) untuk mengeksekusi kalkulasi matematika tanpa mengharuskan kita menulis kode tingkat rendah yang rumit.

##### **Penjelasan Teori Rinci**

Python diciptakan oleh Guido van Rossum pada akhir dekade 1980-an dengan filosofi desain yang menekankan keterbacaan kode. Salah satu semboyan terkenal dalam komunitas Python adalah "keterbacaan itu penting" (*readability counts*). Hal ini membuat Python sangat berbeda dari bahasa pemrograman seperti C++ atau Java yang membutuhkan banyak kode standar hanya untuk menampilkan satu baris teks ke layar.
...
Sistem pengetikan dinamis pada Python membebaskan pengembang dari deklarasi tipe data secara eksplisit. Tipe data ditentukan secara otomatis pada saat runtime berdasarkan nilai yang dimasukkan ke dalam variabel tersebut. Hal ini mempercepat proses pembuatan prototipe algoritma kecerdasan buatan, meskipun menuntut pemahaman mendalam agar tidak terjadi kesalahan tipe data di tengah jalan.
Meskipun Python lambat jika mengeksekusi perulangan komputasi numerik murni secara internal, ekosistem kecerdasan buatan menyiasati hal ini dengan menggunakan modul berbasis bahasa C/C++ di balik layar. Pustaka populer seperti NumPy dan PyTorch ditulis menggunakan bahasa C++ yang sangat teroptimasi untuk dijalankan pada prosesor dan kartu grafis. Python bertindak sebagai jembatan kendali tingkat tinggi, memberikan kecepatan eksekusi setara C++ namun dengan kemudahan menulis kode ala Python.
Ketergantungan industri kecerdasan buatan pada Python juga didukung oleh komunitas global yang sangat aktif. Setiap kali terdapat terobosan baru di bidang kecerdasan buatan, para peneliti hampir selalu merilis kodenya dalam bentuk pustaka Python. Hal ini menjadikan Python sebagai standar de facto yang harus dikuasai oleh setiap calon praktisi data science dan kecerdasan buatan.
Namun, Python bukanlah solusi untuk segala hal. Bahasa ini tidak direkomendasikan untuk pengembangan sistem operasi tingkat rendah, driver perangkat keras, atau game 3D real-time berkinerja tinggi yang membutuhkan manajemen memori manual yang sangat ketat. Untuk ranah kecerdasan buatan, keterbatasan ini tidak menjadi masalah karena Python memang diposisikan sebagai bahasa kontrol, bukan bahasa mesin komputasi murni.
...
* **Baris 1**: print("Halo AI\!") Baris ini memanggil fungsi bawaan print() yang bertugas mengirimkan data ke layar terminal. Argumen yang diberikan adalah string "Halo AI\!" yang diapit oleh tanda kutip ganda. Interpreter Python mengevaluasi fungsi ini dan mencetak teks tersebut ke media keluaran standar.
...
1. Menampilkan teks multi-baris menggunakan satu fungsi print 4:
   ...
   * **Baris 1**: print(...) memanggil fungsi pencetakan. String di dalamnya mengandung karakter khusus \\n yang bertindak sebagai instruksi untuk membuat baris baru. Hasil cetakan di terminal akan terbagi menjadi dua baris.
...
3. Menggabungkan beberapa teks menggunakan koma di dalam fungsi print 4:
   ...
   *Penjelasan baris demi baris*:
   * **Baris 1**: print(...) menerima tiga argumen string terpisah yang dipisahkan oleh tanda koma. Secara default, fungsi print akan menggabungkan argumen-argumen tersebut dan menyisipkan karakter spasi sebagai pemisah di antara mereka saat ditampilkan di layar.
...
Semua kerangka kerja kecerdasan buatan modern, seperti PyTorch, TensorFlow, dan Scikit-Learn, dikendalikan menggunakan fungsi-fungsi Python. Memahami bagaimana Python mengeksekusi fungsi sederhana seperti print() adalah langkah pertama untuk memahami bagaimana kita nantinya akan memanggil fungsi untuk melatih model klasifikasi gambar atau memproses teks alami.
...
Python adalah bahasa tingkat tinggi yang interpretatif, dinamis, dan sangat diandalkan dalam dunia kecerdasan buatan sebagai bahasa kontrol. Menulis kode Python diawali dengan memahami instruksi dasar seperti fungsi print() yang sensitif terhadap penulisan huruf dan struktur indentasi.

#### **Chapter: Instalasi dan Environment**

##### **Tujuan Chapter**

Peserta mampu melakukan instalasi Python, mengonfigurasi VS Code, serta membuat dan mengaktifkan lingkungan virtual untuk mengelola dependensi proyek tanpa konflik.
...
* **Langkah 1**: python \-m venv env\_ai Perintah terminal ini memanggil interpreter Python dengan opsi \-m untuk menjalankan modul bawaan bernama venv. Argumen terakhir, env\_ai, adalah nama direktori baru yang akan dibuat. Direktori ini akan berisi salinan eksekutif Python, skrip aktivasi terminal, dan folder kosong untuk menampung pustaka pihak ketiga secara terisolasi.
...
1. Mengaktifkan lingkungan virtual di Windows (melalui Command Prompt):
   ...
   *Penjelasan baris demi baris*:
   * **Baris 1**: env\_ai\\Scripts\\activate menjalankan skrip aktivasi Windows. Eksekusi ini akan memodifikasi variabel lingkungan PATH di terminal aktif sehingga menunjuk ke direktori biner di dalam env\_ai.
2. Mengaktifkan lingkungan virtual di macOS atau Linux (melalui Terminal):
   Bash
   source env\_ai/bin/activate

   *Penjelasan baris demi baris*:
   * **Baris 1**: source env\_ai/bin/activate menggunakan perintah source pada shell Unix untuk menjalankan skrip aktivasi dalam sesi shell yang sama. Perubahan path interpreter akan langsung diterapkan pada terminal aktif.
3. Menghasilkan daftar dependensi proyek ke dalam file eksternal 8:
   Bash
   pip freeze \> requirements.txt

   *Penjelasan baris demi baris*:
   * **Baris 1**: pip freeze menampilkan daftar pustaka beserta versinya yang terpasang di lingkungan virtual aktif. Simbol \> mengalihkan keluaran tersebut untuk ditulis langsung ke dalam berkas teks bernama requirements.txt.
...
1. Selalu buat satu lingkungan virtual unik untuk setiap proyek kecerdasan buatan baru yang dikerjakan.
...
3. Catat semua pustaka yang dipasang ke dalam sebuah berkas teks menggunakan perintah pip freeze \> requirements.txt agar orang lain dapat merekonstruksi lingkungan kerja Anda dengan mudah.

##### **Hubungan Konsep Ini dengan AI/Data Science**

Model kecerdasan buatan modern sangat bergantung pada kecocokan versi pustaka. Misalnya, kode jaringan saraf tiruan yang ditulis menggunakan PyTorch versi 1.x bisa saja mengalami kerusakan fungsi jika dijalankan pada PyTorch versi 2.x. Menguasai teknik isolasi lingkungan sejak awal adalah kunci untuk menghindari frustrasi akibat kegagalan eksekusi model kecerdasan buatan yang diunduh dari internet.

##### **Latihan Kecil dengan Contoh Jawaban**

Tuliskan urutan perintah terminal untuk membuat lingkungan virtual bernama herai\_dev, mengaktifkannya di macOS/Linux, dan memeriksa daftar pustaka yang terpasang. *Contoh Jawaban*:
...
Mengelola workspace pemrograman yang bersih melibatkan pembuatan lingkungan virtual terisolasi menggunakan venv. Praktik ini mencegah bentrokan antar-pustaka dan memastikan eksperimen kecerdasan buatan Anda dapat direproduksi secara konsisten di komputer mana pun.
...
Dalam Python, ketika menulis x \= 10, kita tidak sedang membuat wadah kaku yang hanya boleh diisi oleh angka. Secara teknis, Python menggunakan model referensi objek. interpreter akan membuat objek bertipe int dengan nilai 10 di dalam memori, lalu menempelkan label nama x ke objek tersebut. Jika kemudian menulis x \= "Halo", label x hanya dipindahkan untuk menunjuk ke objek String baru berisi "Halo". Objek lama 10 yang kehilangan referensinya akan dibersihkan secara otomatis oleh sistem pengumpul sampah Python.
Mari kita telaah karakteristik dari masing-masing tipe data dasar ini:
**String (str)**: Digunakan untuk merepresentasikan teks. String dalam Python bersifat *immutable*, artinya setelah objek string dibuat di memori, isinya tidak dapat diubah secara langsung. Segala operasi manipulasi string, seperti mengubah huruf menjadi kapital atau memotong teks, sebenarnya membuat objek string baru di memori.
**Integer (int)**: Merepresentasikan bilangan bulat positif, negatif, atau nol tanpa komponen desimal. Keunggulan unik Python adalah presisi integer yang dinamis, yang berarti ukuran angka bulat yang bisa disimpan hanya dibatasi oleh kapasitas memori komputer, berbeda dengan bahasa lain yang membatasi integer pada ukuran 32-bit atau 64-bit.
**Float (float)**: Digunakan untuk menyimpan bilangan real yang memiliki angka di belakang koma desimal. Representasi internal float dalam Python menggunakan format standar IEEE 754 double-precision (64-bit). Karena keterbatasan representasi biner untuk bilangan desimal, operasi aritmatika float kadang menghasilkan sedikit ketidakakuratan kecil (misalnya 0.1 \+ 0.2 menghasilkan 0.30000000000000004), suatu fenomena penting yang harus dipahami oleh praktisi kecerdasan buatan saat melakukan perhitungan numerik tingkat tinggi.
**Boolean (bool)**: Hanya memiliki dua nilai konstan: True (Benar) dan False (Salah). Tipe data ini merupakan turunan langsung dari kelas Integer, di mana secara internal True bernilai 1 dan False bernilai 0\. Boolean sangat vital dalam menyusun logika percabangan program.
...
1. Konversi tipe data secara eksplisit 4:
   ...
   * **Baris 2**: skor\_numerik \= int(input\_pengguna) mengonversi String "85" menjadi objek Integer 85 menggunakan fungsi int().
   * **Baris 3**: print(skor\_numerik \+ 10) melakukan penjumlahan matematika (85 \+ 10 \= 95) dan mencetak hasilnya.
2. Penggabungan string menggunakan metode f-string :
   ...
   * **Baris 4**: print(pesan) mencetak string gabungan tersebut.
3. Operasi aritmatika campuran yang otomatis menghasilkan tipe data float 11:
   ...
   * **Baris 3**: hasil\_bagi \= bilangan\_bulat / pembagi melakukan pembagian menggunakan operator /. Di Python, operator ini selalu menghasilkan Float.
...
1. Gunakan gaya penulisan *snake\_case* (huruf kecil semua dipisahkan garis bawah) untuk menamai variabel, contoh: dataset\_path, learning\_rate.
2. Pilihlah nama variabel yang deskriptif dan mencerminkan isinya, hindari nama satu huruf seperti x, y, atau z kecuali untuk indeks perulangan matematika sederhana.
...
Variabel berfungsi sebagai label referensi untuk objek data di dalam memori komputer. Penguasaan atas empat tipe data dasar (String, Integer, Float, dan Boolean) serta cara melakukan konversi antar-tipe data tersebut sangat penting untuk mengelola informasi secara akurat.
...
3. Mengakses Dictionary menggunakan metode .get() yang aman :
   ...
   * **Baris 3**: print(lr) mencetak nilai tersebut.
...
Struktur data koleksi adalah fondasi manipulasi dataset. Kumpulan teks mentah untuk pemrosesan bahasa alami disimpan dalam List. Metadata label gambar dalam visi komputer dikelola menggunakan Dictionary. Pengenalan dimensi citra didefinisikan menggunakan Tuple.
...
Peserta mampu merancang alur logika keputusan program menggunakan operator perbandingan, operator logika, serta struktur kontrol percabangan if, elif, dan else.

##### **Konsep Utama**

Percabangan mengontrol eksekusi baris kode berdasarkan evaluasi kondisi boolean. Python mengevaluasi ekspresi kondisional dari atas ke bawah dan mengeksekusi blok kode pertama yang bernilai True.

##### **Analogi**

Bayangkan percabangan seperti **Gerbang Pemeriksaan Otomatis** di bandara. Gerbang akan mengecek kondisi dokumen Anda: **Jika** memiliki paspor diplomatik, Anda melewati jalur khusus pertama. **Jika tidak (Elif)**, jika memiliki paspor reguler yang valid, Anda melewati jalur pemeriksaan umum. **Selain itu (Else)**, jika semua syarat tidak terpenuhi, Anda diarahkan ke loket penanganan darurat.

##### **Penjelasan Teori Rinci**

Secara default, interpreter Python mengeksekusi kode secara berurutan baris demi baris dari atas ke bawah. Namun, aplikasi dunia nyata membutuhkan kemampuan untuk mengambil keputusan secara dinamis. Struktur percabangan memungkinkan program untuk memilih jalur eksekusi yang berbeda berdasarkan kondisi data saat ini.
Struktur percabangan di Python ditulis dengan kata kunci if, diikuti oleh ekspresi kondisi, dan diakhiri dengan titik dua. Blok kode yang termasuk dalam percabangan tersebut ditentukan menggunakan tingkat indentasi, bukan menggunakan tanda kurung kurawal seperti pada bahasa pemrograman lain.
...
* and: Mengembalikan True hanya jika kedua kondisi bernilai benar.
* or: Mengembalikan True jika salah satu atau kedua kondisi bernilai benar.
* not: Membalik nilai boolean.

Ketika mengevaluasi rantai keputusan if \- elif \- else, Python bekerja secara *short-circuit*.4 Artinya, begitu Python menemukan satu kondisi yang bernilai True, ia akan langsung mengeksekusi blok kode di bawahnya dan mengabaikan semua kondisi berikutnya dalam rantai tersebut, meskipun kondisi di bawahnya mungkin juga bernilai benar. Oleh karena itu, urutan penulisan kondisi dari yang paling spesifik ke yang paling umum sangatlah krusial.
...
* **Baris 2**: if akurasi \>= 0.90: Mengevaluasi apakah nilai akurasi lebih besar atau sama dengan 0.90.4 Karena 0.85 \>= 0.90 bernilai False, blok di bawahnya diabaikan.
* **Baris 4**: elif akurasi \>= 0.75: Karena kondisi pertama gagal, Python menguji kondisi ini. 0.85 \>= 0.75 bernilai True, sehingga program memasuki blok ini.
* **Baris 5**: print("Model Cukup Akurat") Mencetak teks "Model Cukup Akurat".4 Jalur percabangan selesai dan blok else diabaikan.
...
1. Menggunakan operator logika and untuk memvalidasi beberapa kriteria 11:
   ...
   * **Baris 4**: if loss \< 0.15 and val\_accuracy \> 0.85: mengevaluasi kedua kondisi. Karena keduanya bernilai True, operasi and menghasilkan True.
   * **Baris 5**: print("Model Stabil") dijalankan.
2. Memeriksa keberadaan elemen di dalam List menggunakan operator in :
   ...
   * **Baris 3**: print("Token Ditemukan") mencetak pesan karena kondisi bernilai True.
...
1. **Menggunakan Operator Penugasan sebagai Pembanding**: Menulis if skor \= 100: alih-alih if skor \== 100:. Karakter \= tunggal digunakan untuk memasukkan nilai ke variabel, sedangkan \== ganda digunakan untuk membandingkan nilai.
2. **Kesalahan Indentasi**: Menulis kode di dalam blok percabangan tanpa memberikan spasi indentasi yang seragam di awal baris.
3. **Tumpang Tindih Kondisi yang Tidak Logis**: Menuliskan kondisi yang lebih umum di atas kondisi yang lebih spesifik, sehingga kondisi spesifik tidak pernah tercapai karena terpotong oleh evaluasi awal.

##### **3 Best Practices**

1. Pastikan blok keputusan mencakup kondisi alternatif melalui else untuk menangani skenario data yang tidak terduga agar program tidak lolos begitu saja tanpa penanganan.
...
Algoritma kecerdasan buatan sering kali menggunakan logika ambang batas. Misalnya, sebuah sistem klasifikasi sentimen mendeteksi bahwa peluang sebuah ulasan bernilai positif adalah . Program Python akan menggunakan blok if untuk menentukan: jika peluang tersebut berada di atas , maka ulasan diklasifikasikan sebagai positif, jika tidak, diklasifikasikan sebagai negatif.
...
Struktur kontrol percabangan yang didukung oleh operator perbandingan dan logika memungkinkan pembuatan keputusan pemrograman secara dinamik berdasarkan data masukan.

#### **Chapter: Perulangan**

##### **Tujuan Chapter**

Peserta mampu mengotomatisasi proses berulang menggunakan perulangan for dan while, mengendalikan alurnya dengan break dan continue, serta melakukan iterasi pada berbagai struktur data koleksi.

##### **Konsep Utama**

Perulangan mengeksekusi sekumpulan instruksi secara berulang. Perulangan for digunakan saat jumlah iterasi sudah diketahui secara pasti (misalnya melintasi elemen List), sedangkan while berjalan selama suatu kondisi logika bernilai True.
...
* **While loop** adalah instruksi memindahkan kotak barang dari ban berjalan ke dalam truk. Anda terus memindahkan kotak **selama** lampu indikator hijau masih menyala. Begitu lampu berubah menjadi merah, Anda berhenti, tidak peduli berapa banyak kotak yang sudah Anda pindahkan.

##### **Penjelasan Teori Rinci**

Mengulang proses adalah kekuatan utama komputer dibandingkan manusia. Di dalam Python, terdapat dua mekanisme utama untuk memfasilitasi perulangan ini:
**For Loop**: Perulangan ini bekerja menggunakan protokol iterator. Python mengambil objek yang dapat diiterasi seperti List, Tuple, atau String, lalu melintasi elemen-elemennya satu per satu dari awal hingga akhir secara berurutan. Variabel iterasi akan diperbarui secara otomatis di setiap putaran untuk menyimpan nilai elemen aktif saat itu. Fungsi pembantu range(start, stop, step) sangat sering digunakan untuk menghasilkan deret angka urut secara dinamis tanpa harus menuliskan semua angka tersebut secara manual di dalam memori.
**While Loop**: Perulangan ini didasarkan pada evaluasi kondisi boolean yang mirip dengan struktur if. Di awal setiap putaran, Python akan memeriksa kondisi yang ditentukan. Jika bernilai True, blok kode di dalam putaran dijalankan. Jika bernilai False, perulangan langsung dihentikan dan program berlanjut ke baris setelah blok perulangan. Di dalam blok while, kita wajib menyertakan instruksi yang mengubah nilai variabel kondisi (misalnya penambahan angka), agar kondisi tersebut suatu saat bisa menjadi False. Jika tidak, program akan terjebak dalam perulangan tanpa akhir yang menguras memori komputer.
Untuk memberikan kontrol yang lebih presisi, Python menyediakan dua kata kunci kendali:

* break: Menghentikan seluruh proses perulangan secara paksa seketika itu juga dan keluar dari blok perulangan, bahkan jika kondisi perulangan sebenarnya masih terpenuhi.
* continue: Menghentikan putaran aktif saat ini dan langsung melompat ke awal putaran berikutnya, melewati sisa baris kode di bawahnya dalam putaran tersebut.
...
* **Baris 1**: for i in range(3): Mengeksekusi perulangan for menggunakan deret angka yang dihasilkan oleh range(3) (yaitu 0, 1, 2). Di setiap putaran, variabel i akan menyimpan nilai angka aktif saat itu.
* **Baris 2**: print(f"Perulangan ke-{i}") Mencetak teks f-string yang menampilkan indeks angka aktif. Setelah putaran untuk nilai 2 selesai, program keluar dari perulangan secara otomatis.
...
1. Perulangan melintasi elemen List :
   ...
   * **Baris 3**: print(loss) mencetak nilai loss aktif di setiap putaran.
2. Menggunakan perulangan while terkontrol 6:
   ...
   * **Baris 2**: while counter \<= 3: mengecek kondisi. Selama counter kurang dari atau sama dengan 3, blok di bawahnya dieksekusi.
   * **Baris 3**: print(counter) mencetak nilai counter aktif.
   * **Baris 4**: counter \+= 1 menambah nilai counter sebesar 1 agar perulangan tidak berjalan selamanya.
...
1. **Infinite Loop karena Lupa Modifikasi Kondisi**: Menulis while dengan variabel kondisi yang nilainya tidak pernah diubah di dalam blok perulangan, sehingga program berjalan selamanya dan membuat komputer hang.
...
1. Gunakan **For Loop** sebagai pilihan utama jika sudah tahu batas akhir iterasi atau sedang bekerja dengan objek koleksi data.
2. Selalu berikan batasan maksimal iterasi jika terpaksa menggunakan perulangan while untuk menghindari risiko *infinite loop* tak terduga.
...
Pelatihan model kecerdasan buatan pada dasarnya adalah perulangan raksasa. Proses menyuapkan data ke model, menghitung eror, dan memperbarui bobot model diulangi ribuan kali. Setiap satu putaran penuh atas seluruh dataset dikenal dengan istilah **Epoch**. Pemahaman tentang bagaimana mengontrol perulangan sangat krusial saat mengimplementasikan iterasi epoch ini.

##### **Latihan Kecil dengan Contoh Jawaban**

Tuliskan perulangan for yang melintasi angka 1 sampai 5, namun lewati cetakan untuk angka 3 menggunakan kata kunci continue. *Contoh Jawaban*:
...
Mekanisme perulangan (for dan while) menyederhanakan eksekusi proses berulang pada data, sementara kata kunci break dan continue memberikan kendali penuh untuk menghentikan atau mengalihkan putaran berdasarkan dinamika data.
...
Peserta mampu mendesain fungsi yang modular dengan parameter wajib, parameter opsional, serta nilai kembalian untuk menghasilkan kode yang bersih dan tidak redundan.

##### **Konsep Utama**

Fungsi adalah blok kode terorganisir yang dapat digunakan kembali untuk melakukan satu tugas spesifik. Fungsi menerima masukan melalui parameter dan mengirimkan hasil pemrosesan kembali menggunakan kata kunci return.
...
Menulis kode yang sama berulang kali di berbagai tempat dalam satu aplikasi adalah praktik buruk yang mempersulit pemeliharaan program. Jika terjadi kesalahan pada logika tersebut, pengembang harus melacak dan mengubahnya di setiap tempat satu per satu. Fungsi menyelesaikan masalah ini dengan menerapkan prinsip DRY (*Don't Repeat Yourself*).
Di dalam Python, fungsi dideklarasikan menggunakan kata kunci def, diikuti oleh nama fungsi, tanda kurung yang berisi daftar parameter (jika ada), dan diakhiri dengan titik dua. Tubuh fungsi ditulis dengan indentasi masuk di bawah baris deklarasi tersebut.
...
* **Baris 1**: def hitung\_akurasi(benar, total): Mendeklarasikan fungsi baru bernama hitung\_akurasi yang membutuhkan dua parameter wajib: benar dan total.
...
2. Fungsi yang mengembalikan beberapa nilai sekaligus menggunakan Tuple :
   ...
   *Penjelasan baris demi baris*:
   * **Baris 1**: def kalkulasi\_min\_max(...) menerima list angka.
   * **Baris 2**: return min(list\_angka), max(list\_angka) mencari nilai minimum dan maksimum, lalu mengembalikannya sekaligus.
   * **Baris 4**: terendah, tertinggi \=... memanggil fungsi dan langsung memecah Tuple hasil kembalian ke dalam dua variabel terpisah.
3. Fungsi tanpa nilai kembalian (hanya efek samping cetak) :
   ...
   *Penjelasan baris demi baris*:
   * **Baris 1**: def log\_status(pesan): mendeklarasikan fungsi logger.
   * **Baris 2**: print(f"\[LOG\]: {pesan}") mencetak log status ke konsol terminal. Fungsi ini tidak memiliki pernyataan return, sehingga mengembalikan objek kosong None secara implisit.
...
1. Buatlah fungsi yang berfokus melakukan satu tugas secara spesifik agar kode mudah diuji dan dikelola.
...
Dalam alur kerja kecerdasan buatan, seluruh proses persiapan data dipisahkan ke dalam fungsi-fungsi modular. Kita membuat satu fungsi khusus untuk membaca data, satu fungsi untuk membersihkan teks dari tanda baca, satu fungsi untuk melakukan normalisasi angka, dan satu fungsi untuk menghitung metrik akurasi akhir. Modularisasi ini membuat pipeline data menjadi sangat bersih dan mudah dimodifikasi tanpa risiko merusak bagian kode yang lain.
...
Fungsi mengubah sekumpulan instruksi menjadi satu unit operasional modular yang dapat digunakan kembali, efisien, serta mudah dikelola melalui pengaturan parameter masukan dan pengembalian nilai hasil kalkulasi.

#### **Chapter: Lambda Expression dan Generator Basics**

##### **Tujuan Chapter**

Peserta mampu menyusun fungsi anonim sekali pakai menggunakan ekspresi Lambda dan menghemat konsumsi memori untuk aliran data besar menggunakan konsep Generator sederhana.

##### **Konsep Utama**

Lambda adalah fungsi tanpa nama yang ditulis dalam satu baris ekspresi tunggal. Generator adalah jenis fungsi khusus yang menghasilkan urutan nilai secara bertahap menggunakan kata kunci yield alih-alih mengembalikan semua nilai sekaligus di memori.

##### **Analogi**

* **Lambda Expression** seperti **Pena Sekali Pakai** di bank. Anda hanya membutuhkannya untuk menandatangani satu slip formulir cepat, lalu Anda meninggalkannya begitu saja tanpa perlu menyimpannya di tempat pensil khusus.
* **Generator** seperti **Keran Dispenser Air**. Jika membutuhkan 10 liter air untuk diminum sepanjang hari, Anda tidak perlu membawa ember raksasa 10 liter ke mana-mana. Cukup gunakan botol kecil, dan putar keran dispenser untuk mengeluarkan air **hanya pada saat haus** satu gelas demi satu gelas.

##### **Penjelasan Teori Rinci**

Seiring dengan semakin besarnya skala aplikasi kecerdasan buatan dan sains data yang kita bangun, teknik penulisan kode konvensional kadang tidak lagi efisien. Python menyediakan fitur pemrograman fungsional tingkat lanjut untuk menyiasati keterbatasan efisiensi penulisan dan memori.
**Lambda Expression**: Ditulis dengan kata kunci lambda, diikuti parameter, tanda titik dua, dan ekspresi tunggal yang langsung dievaluasi serta dikembalikan hasilnya. Sintaksis Lambda sangat minimalis karena tidak membutuhkan kata kunci def maupun pernyataan return. Karakteristik utama Lambda adalah ia tidak memiliki nama di ruang namespace program. Lambda biasanya digunakan sebagai argumen untuk fungsi tingkat tinggi yang menerima fungsi lain sebagai masukannya, seperti fungsi filter, sorting khusus, atau fungsi pemetaan data pada Pandas DataFrame.
**Generator**: Fungsi normal di Python akan menghitung semua nilai hasil kalkulasi, menyimpannya di dalam memori sebagai satu List besar, lalu mengembalikannya ke pemanggil. Namun, jika dataset Anda berisi jutaan baris dokumen teks, menyimpannya sekaligus dalam memori akan menyebabkan sistem kehabisan RAM. Generator mengatasi masalah ini dengan menerapkan prinsip evaluasi malas.
Generator dideklarasikan seperti fungsi biasa menggunakan def, namun alih-alih menggunakan return, ia menggunakan kata kunci yield. Ketika fungsi generator dipanggil, ia tidak langsung menjalankan kode di dalamnya. Ia hanya mengembalikan objek generator. Ketika program meminta nilai berikutnya (misalnya melalui fungsi next() atau perulangan for), generator akan berjalan hingga menemui baris yield, mengembalikan nilai tersebut, dan **membekukan status eksekusinya** di titik tersebut. Saat diminta nilai berikutnya lagi, generator melanjutkan eksekusi dari titik beku tersebut.
...
* **Baris 1**: kali\_dua \= lambda x: x \* 2 Membuat fungsi anonim Lambda yang menerima satu parameter x dan langsung mengembalikan hasil perkalian x \* 2\.6 Fungsi ini disimpan ke variabel referensi kali\_dua agar bisa dipanggil.
* **Baris 3**: def generator\_angka(): Mendeklarasikan fungsi generator khusus menggunakan kata kunci def.
* **Baris 4**: yield 1 Menyerahkan angka 1 ke program utama dan menjeda eksekusi fungsi generator.
...
1. Menggunakan Lambda bersama fungsi filter 6:
   ...
   * **Baris 2**: loss\_kecil \=... memanggil fungsi filter() yang menyaring elemen list menggunakan ekspresi Lambda lambda x: x \< 0.5.6 Hasil saringan dikonversi kembali menjadi List.
   * **Baris 3**: print(loss\_kecil) mencetak \[0.4, 0.2\].
2. Membuat Generator deret angka genap dinamis 1:
   ...
   *Penjelasan baris demi baris*:
   * **Baris 1**: def genap\_generator(maks): mendeklarasikan generator.
   * **Baris 3**: while n \< maks: mengevaluasi batas perulangan.
   * **Baris 4**: yield n mengeluarkan angka genap aktif dan menjeda fungsi.
   * **Baris 5**: n \+= 2 menaikkan nilai variabel untuk putaran berikutnya.
   * **Baris 7**: for angka in... melintasi generator, menghasilkan output cetak 0 dan 2 secara bertahap.
3. List Comprehension sebagai bentuk ringkas pemrosesan data 6:
   ...
   * **Baris 2**: skor\_bersih \= \[x \+ 5 for x in skor\_mentah\] menggunakan sintaksis List Comprehension untuk menambah setiap elemen dengan 5 secara ringkas dan cepat.
   * **Baris 3**: print(skor\_bersih) mencetak \`\`.4

##### **3 Common Mistakes**

1. **Mencoba Menulis Banyak Baris Logika di Dalam Lambda**: Memaksakan percabangan atau perulangan di dalam ekspresi Lambda. Ingat bahwa Lambda dirancang hanya untuk menampung ekspresi satu baris tunggal.
2. **Menggunakan Generator yang Sudah Habis**: Berusaha membaca ulang elemen dari generator yang sudah selesai dilintasi. Generator hanya bisa dibaca satu kali melintas; jika ingin dibaca ulang, Anda harus menginstansiasi ulang objek generator baru dari fungsinya.
3. **Mengasumsikan Generator Menyimpan Data Secara Fisik**: Mengira bahwa objek generator adalah sebuah list yang bisa diperiksa panjangnya menggunakan fungsi len(). Hal ini akan langsung memicu TypeError karena generator tidak memiliki konsep ukuran panjang sebelum dievaluasi secara tuntas.

##### **3 Best Practices**

1. Gunakan **Lambda Expression** hanya untuk fungsi pemrosesan satu baris yang sangat sederhana dan dilewatkan sebagai argumen fungsi pemetaan pustaka seperti Pandas atau Map.
2. Gunakan **Generator** jika perlu memproses berkas teks besar, logs sistem raksasa, atau batch gambar berukuran gigabyte untuk menghemat kapasitas RAM komputer.
...
Pelatihan model pembelajaran mendalam modern tidak mungkin dilakukan tanpa generator. Dataset gambar medis atau teks internet raksasa berukuran ratusan gigabyte tidak akan muat di memori komputer. Dengan menggunakan generator (diimplementasikan sebagai *DataLoader* di PyTorch atau *Data Generator* di TensorFlow), model dapat mengambil gambar bertahap 32 per 32 gambar untuk dilatih, membebaskan memori RAM agar program tetap berjalan stabil.

##### **Latihan Kecil dengan Contoh Jawaban**

Buatlah ekspresi Lambda bernama is\_positive yang menerima satu parameter angka dan mengembalikan nilai True jika angka tersebut lebih besar dari nol, dan False jika sebaliknya. *Contoh Jawaban*:
...
Ekspresi Lambda menyederhanakan deklarasi fungsi anonim sekali pakai untuk pemrosesan ringkas. Sementara itu, konsep Generator bertindak sebagai penyelamat kinerja sistem memori saat memproses aliran data bervolume besar melalui evaluasi malas berbasis yield.
...
Peserta memahami filosofi dasar Pemrograman Berorientasi Objek, serta mampu menyusun Class, instansiasi Object, konstruktor \_\_init\_\_, pembuatan metode kelas, dan konsep pewarisan sederhana.

##### **Konsep Utama**

OOP adalah paradigma pemrograman yang menyusun kode dalam bentuk objek-objek mandiri yang menggabungkan data (Attributes) dan perilaku (Methods). Class bertindak sebagai cetak biru, sementara Object adalah perwujudan fisik dari cetak biru tersebut.

##### **Analogi**

Bayangkan Class sebagai sebuah **Cetak Biru Arsitek** untuk rumah. Cetak biru tersebut berisi spesifikasi ruangan, warna cat default, dan sistem pipa. Namun, Anda tidak bisa tidur atau berteduh di dalam cetak biru tersebut. Anda harus membangun rumah fisik berdasarkan cetak biru tersebut. Rumah fisik yang sudah jadi inilah yang disebut sebagai **Object** atau **Instance**.7 Anda bisa membangun 10 rumah berbeda dari satu cetak biru yang sama, masing-masing dengan warna cat interior atau perabotan yang unik.

##### **Penjelasan Teori Rinci**

Seiring perkembangan arsitektur perangkat lunak, pemrograman prosedural murni sering kali menyulitkan pengorganisasian kode jika entitas sistem memiliki banyak state internal. Paradigma Pemrograman Berorientasi Objek memecahkan masalah ini dengan mengelompokkan data dan logika terkait ke dalam satu kesatuan struktur logis.
Di dalam Python, pembuatan kelas ditandai dengan kata kunci class diikuti oleh nama kelas yang ditulis dengan konvensi PascalCase.
Mari kita bedah pilar dan elemen penting dalam OOP dasar:
**Konstruktor (\_\_init\_\_)**: Merupakan metode bawaan khusus yang dipanggil secara otomatis oleh Python pada saat objek pertama kali diciptakan di memori. Konstruktor biasanya digunakan untuk menginisialisasi nilai awal dari atribut objek.
**Kata Kunci self**: Mewakili referensi ke instansi objek aktif yang sedang memanggil metode tersebut. Melalui self, kita dapat mengakses dan memodifikasi atribut milik objek tersebut di dalam metode kelas. Setiap kali kita mendefinisikan metode di dalam kelas, parameter pertama wajib berupa self.
**Pewarisan (*Inheritance*)**: Memungkinkan suatu kelas baru (disebut kelas anak) untuk mewarisi seluruh atribut dan metode dari kelas yang sudah ada (disebut kelas induk). Konsep ini sangat menghemat penulisan kode karena kita tidak perlu mendefinisikan ulang logika umum yang dimiliki oleh beberapa entitas sejenis. Kita cukup menuliskan perbedaan atau fitur tambahan khusus di kelas anak.
...
* **Baris 1**: class Model: Mendeklarasikan kelas dasar bernama Model.
* **Baris 2**: def \_\_init\_\_(self, nama): Mendefinisikan metode konstruktor kelas induk yang menerima satu argumen masukan nama.
* **Baris 3**: self.nama \= nama Mengikat nilai argumen masukan ke dalam atribut instansi nama milik objek bersangkutan menggunakan kata kunci self.
* **Baris 5**: class JaringanSaraf(Model): Mendefinisikan kelas anak bernama JaringanSaraf yang mewarisi seluruh sifat dari kelas induk Model.
* **Baris 6**: def latih(self): Mendefinisikan metode baru khusus untuk kelas anak.
* **Baris 7**: return f"Melatih model: {self.nama}" Mengembalikan pesan teks yang memanfaatkan atribut nama yang diwarisinya dari kelas induk.
* **Baris 9**: nn \= JaringanSaraf("MultiLayerPerceptron") Melakukan instansiasi untuk membuat objek baru di memori komputer.
...
1. Kelas dengan variabel statis bersama:
   ...
   *Penjelasan baris demi baris*:
   * **Baris 1**: class AsistenAI: mendeklarasikan kelas.
   * **Baris 2**: versi \= "2.0" menetapkan atribut kelas bersama.
   * **Baris 4**: def \_\_init\_\_(...) menetapkan konstruktor kelas.
   * **Baris 7**: bot \=... membuat objek instansi.
   * **Baris 8**: print(bot1.versi) mengakses variabel kelas statis.
2. Mendefinisikan ulang perilaku pencetakan objek menggunakan \_\_str\_\_ 7:
   ...
   *Penjelasan baris demi baris*:
   * **Baris 1**: class Metrik: mendefinisikan kelas baru.
   * **Baris 5**: def \_\_str\_\_(self): mendefinisikan ulang metode representasi teks internal objek.
   * **Baris 9**: print(m) otomatis memanggil fungsi \_\_str\_\_ yang mengembalikan kalimat berformat kustom.
3. Metode pembaruan atribut internal di dalam kelas 12:
   ...
   *Penjelasan baris demi baris*:
   * **Baris 1**: class Dataset: mendefinisikan kelas pengelola data.
   * **Baris 3**: self.jumlah\_baris \= 0 menginisialisasi nilai atribut awal.
   * **Baris 4**: def tambah\_data(self, n): membuat metode untuk memperbarui status.
   * **Baris 5**: self.jumlah\_baris \+= n menambah nilai atribut internal.
   * **Baris 7**: ds \= Dataset() melakukan instansiasi objek.
   * **Baris 8**: ds.tambah\_data(100) memperbarui data objek menjadi 100\.12

##### **3 Common Mistakes**

1. **Lupa Menuliskan Parameter self**: Menuliskan fungsi di dalam kelas seperti def info(): tanpa menyertakan self sebagai parameter pertama. Akibatnya, saat metode dipanggil melalui objek, Python akan memicu TypeError: info() takes 0 positional arguments but 1 was given.
2. **Mengasumsikan Properti Instansi Bersifat Statis**: Mengubah atribut instansi pada satu objek dan mengira perubahan tersebut akan otomatis memengaruhi objek lainnya. Setiap instansi objek memiliki ruang memori atributnya sendiri-sendiri.
...
1. Gunakan konvensi penamaan kelas dengan format PascalCase (contoh: JaringanSarafTiruan, PreprocessPipeline) dan gunakan kata benda.
2. Jaga agar sebuah kelas tetap fokus pada tanggung jawab tunggal, jangan membuat kelas raksasa yang mengurusi semua urusan aplikasi dari koneksi database hingga pelatihan model kecerdasan buatan.
3. Gunakan tanda garis bawah tunggal (\_) atau ganda (\_\_) di depan nama atribut untuk menandai secara konvensi bahwa atribut tersebut bersifat privat agar tidak diakses langsung dari luar kelas.

##### **Hubungan Konsep Ini dengan AI/Data Science**

Seluruh pustaka pembelajaran mesin modern dirancang menggunakan OOP. Di Scikit-Learn, setiap model (seperti LinearRegression atau RandomForestClassifier) adalah sebuah Class. Anda membuat objeknya, lalu memanggil metode .fit() untuk melatih model dan .predict() untuk menghasilkan prediksi. Di PyTorch, model jaringan saraf tiruan kustom Anda wajib dideklarasikan sebagai kelas anak yang mewarisi torch.nn.Module.

##### **Latihan Kecil dengan Contoh Jawaban**

Buatlah Class bernama Tokenizer yang menerima parameter vocab (list kata) pada konstruktornya. Buat metode bernama is\_known yang menerima satu parameter string kata dan mengembalikan True jika kata tersebut ada di dalam vocab, dan False jika sebaliknya. *Contoh Jawaban*:
...
Paradigma Pemrograman Berorientasi Objek memfasilitasi pengorganisasian kode yang rapi, modular, dan dapat diandalkan melalui pemodelan struktur Class, instansiasi Object dengan state atribut internalnya masing-masing, serta perluasan fungsionalitas lewat mekanisme pewarisan sifat.
...
Penanganan kesalahan mencegah program mati seketika saat menemui kendala runtime dengan mengalihkan kendali eksekusi ke blok penanganan darurat kustom.

##### **Analogi**

Bayangkan Anda sedang berkendara menggunakan mobil dengan **Sistem Autopilot**. Di jalur utama yang mulus, sistem berjalan lancar. Namun, tiba-tiba di tengah jalan terdapat genangan air yang sangat dalam atau jalanan amblas. Jika sistem autopilot tidak memiliki penanganan kondisi darurat, mobil akan langsung menabrak rintangan atau mati mesin di tengah jalan. Namun, jika diprogram dengan baik, sistem akan mendeteksi rintangan tersebut (**Try**), menghentikan kemudi otomatis (**Except**), membunyikan alarm peringatan, dan menyerahkan kendali kembali secara aman kepada pengemudi manusia (**Finally**).

##### **Penjelasan Teori Rinci**

Eror dalam pemrograman diklasifikasikan menjadi dua jenis utama :
**Syntax Error**: Terjadi saat penulisan kode melanggar aturan sintaksis Python. Eror jenis ini dideteksi sebelum program mulai dijalankan.
**Exceptions (Runtime Error)**: Terjadi ketika sintaksis kode sudah benar, namun terjadi anomali tidak terduga pada saat program sedang berjalan. Contoh klasik meliputi pembagian angka dengan nol, memanggil variabel yang tidak ada, membuka berkas yang tidak eksis di cakram keras, atau salah tipe data.
...
1. Menangkap beberapa jenis eror secara terpisah :
   ...
   * **Baris 4**: except KeyError: menangkap kesalahan kunci dan mencetak peringatan.
...
2. Menggunakan blok finally untuk menjamin pembersihan :
   ...
   *Penjelasan baris demi baris*:
   * **Baris 2**: print("Membuka Koneksi") dijalankan.
   ...
   * **Baris 6**: finally: menjamin blok terakhir dijalankan sehingga teks "Koneksi Ditutup" tetap tercetak.
3. Melempar Exception kustom secara sengaja menggunakan raise :
   ...
   *Penjelasan baris demi baris*:
   * **Baris 1**: def validasi\_skor(s): mendefinisikan fungsi validasi.
   * **Baris 3**: raise ValueError(...) memicu kesalahan secara manual jika kondisi terpenuhi.
   * **Baris 5**: try: memantau eksekusi fungsi.
   * **Baris 8**: print(...) menangkap objek pesan kesalahan dan menampilkan rinciannya ke layar.

##### **3 Common Mistakes**

1. **Menggunakan Blok Except Kosong**: Menuliskan kode except: tanpa mendefinisikan tipe eror atau tanpa menuliskan aksi penanganan di dalamnya. Praktik buruk ini menyembunyikan masalah serius dalam kode sehingga membuat proses pencarian bug menjadi sangat sulit.
...
Aplikasi kecerdasan buatan sering kali berinteraksi dengan dunia luar yang tidak ideal. Saat model bertugas mengambil data gambar dari kamera keamanan internet, koneksi jaringan bisa saja terputus di tengah jalan. Saat memproses dataset teks ulasan dari internet, ada kemungkinan beberapa baris ulasan kosong atau rusak. Tanpa adanya penanganan kesalahan menggunakan try-except, satu baris data yang rusak atau gangguan jaringan sesaat dapat mematikan seluruh sistem pengolahan kecerdasan buatan yang sedang berjalan.
...
Peserta mampu melakukan interaksi baca-tulis dokumen fisik pada format teks secara aman menggunakan manajer konteks, serta memahami cara kerja navigasi direktori berkas.

##### **Konsep Utama**

Operasi File I/O memungkinkan penyimpanan dan pembacaan data secara persisten ke dalam cakram keras. Penggunaan struktur with menjamin berkas ditutup otomatis oleh sistem demi mencegah terjadinya penguncian data.

##### **Analogi**

Bayangkan membaca berkas seperti **Mengambil Buku dari Lemari Arsip Terkunci**. Langkah konvensionalnya adalah: Anda mengambil kunci, membuka pintu lemari, mengambil dokumen, membaca isinya, lalu Anda wajib mengunci kembali pintu lemari tersebut dan menyimpan kuncinya. Jika Anda lupa mengunci kembali lemari (atau terjadi kecelakaan di tengah jalan saat Anda membaca), lemari akan tetap terbuka selamanya, berisiko dirusak orang lain atau file terkunci. Penggunaan manajer konteks with bertindak seperti **Petugas Arsip Otomatis** yang mendampingi Anda: ia membukakan lemari, dan begitu selesai membaca atau pergi dari meja, ia langsung mengunci kembali lemari tersebut secara instan tanpa perlu Anda ingat.

##### **Penjelasan Teori Rinci**

Sejauh ini, semua variabel dan objek data yang kita buat hanya disimpan di dalam memori akses acak komputer. Saat program mati atau komputer dimatikan, semua data tersebut akan langsung hilang. Operasi File I/O memungkinkan kita untuk membaca data masukan dari media penyimpanan non-volatile dan menyimpan hasil pemrosesan program secara permanen.
Dalam Python, untuk berinteraksi dengan berkas, kita menggunakan fungsi bawaan open(file, mode). Parameter mode menentukan jenis interaksi yang diizinkan 6:

* "r" (Read): Membuka berkas hanya untuk dibaca. Jika berkas tidak eksis di direktori tujuan, akan muncul eror FileNotFoundError.
* "w" (Write): Membuka berkas untuk ditulis. Jika berkas belum ada, berkas baru akan dibuat secara otomatis. Jika berkas sudah ada, seluruh isi lamanya akan dihapus total (ditimpa).
* "a" (Append): Membuka berkas untuk ditulis, namun isinya tidak dihapus. Data baru yang kita tulis akan ditambahkan di baris paling akhir dari isi berkas lama.

Masalah terbesar bagi pemula saat menulis kode File I/O adalah lupa menutup koneksi berkas menggunakan fungsi .close() setelah operasi selesai. Hal ini dapat menyebabkan penggunaan sumber daya memori yang tidak efisien, mencegah proses lain untuk memodifikasi berkas tersebut, atau bahkan kehilangan data yang belum sempat dikirim dari buffer ke cakram keras.
Untuk mengatasi risiko tersebut, Python menyediakan protokol manajer konteks yang ditandai dengan kata kunci with. Ketika blok with open(...) as f: dibuat, Python akan mendirikan batas eksekusi aman. Begitu program keluar dari blok indentasi with tersebut, Python secara otomatis akan memanggil fungsi .close() di balik layar untuk melepas berkas kembali ke sistem operasi.
...
* **Baris 1**: with open("log.txt", "w") as f: Menggunakan manajer konteks with untuk membuka berkas bernama "log.txt" dalam mode menulis "w".6 Objek berkas dirujuk dengan variabel penunjuk alias f.
* **Baris 2**: f.write("Akurasi: 0.95") Memanggil metode .write() milik objek berkas untuk merekam string "Akurasi: 0.95" ke dalam berkas fisik di hard disk. Setelah baris ini selesai, Python secara otomatis menutup berkas.
...
1. Membaca seluruh konten berkas sekaligus 6:
   ...
   * **Baris 2**: isi \= f.read() memanggil metode .read() untuk menyedot seluruh konten teks berkas menjadi satu string tunggal.
   * **Baris 3**: print(isi) mencetak isi berkas tersebut.
2. Membaca berkas baris demi baris secara efisien menggunakan perulangan 6:
   ...
   *Penjelasan baris demi baris*:
   * **Baris 1**: with open(...) membuka berkas log untuk dibaca.
   * **Baris 2**: for baris in f: memanfaatkan sifat iterable dari objek berkas untuk membaca baris demi baris secara malas, sangat hemat memori RAM.
   * **Baris 3**: print(baris.strip()) mencetak baris dengan membuang karakter spasi atau baris baru di ujung teks menggunakan .strip().
3. Menambahkan baris teks baru tanpa menghapus isi lama menggunakan mode "a" 6:
   ...
   *Penjelasan baris demi baris*:
   * **Baris 1**: with open(...) membuka berkas dengan mode "a" (Append).
   * **Baris 2**: f.write(...) menulis teks tambahan di bagian paling akhir berkas log fisik.
...
2. **Menggunakan Mode "w" Saat Ingin Menambah Data**: Salah memilih mode tulis, berniat ingin menambahkan data baru namun menggunakan mode "w" alih-alih "a". Ini mengakibatkan seluruh data riwayat lama Anda di dalam berkas terhapus bersih secara permanen.
...
1. Selalu gunakan struktur manajer konteks with open(...) untuk menjamin keamanan penutupan berkas secara otomatis.
...
Operasi File I/O adalah gerbang masuk pertama bagi model kecerdasan buatan. Dalam pemrosesan bahasa alami, dataset teks mentah seperti ulasan pelanggan, dokumen PDF hukum, atau percakapan obrolan tersimpan di dalam cakram keras dalam bentuk file teks. Program Python harus membuka file-file tersebut terlebih dahulu, mengekstrak teks di dalamnya baris demi baris, melakukan pembersihan teks, sebelum akhirnya data dikonversi menjadi representasi vektor numerik untuk dilatih oleh model.

##### **Latihan Kecil dengan Contoh Jawaban**

Tuliskan program yang membuat berkas bernama token.txt dan menulis kata "Fellowship" di dalamnya, kemudian baca kembali berkas tersebut dan tampilkan isinya. *Contoh Jawaban*:
...
Interaksi berkas fisik berbasis penyimpanan permanen dikelola dengan menggunakan fungsi open() dan parameter mode aksesnya, di mana struktur manajer konteks with bertindak sebagai pengaman utama pelepasan sumber daya sistem secara otomatis.
...
Peserta mampu melakukan inisialisasi array multi-dimensi menggunakan pustaka NumPy, memahami konsep efisiensi komputasi berbasis vektorisasi, serta mampu mengeksekusi operasi matriks dasar.

##### **Konsep Utama**

NumPy menyediakan objek array multi-dimensi homogen berkinerja tinggi (ndarray). Operasi matematika pada NumPy memanfaatkan kompilasi tingkat rendah C yang menghindari lambatnya perulangan iterasi Python murni.

##### **Analogi**

Bayangkan Anda adalah seorang **Koki Pembuat 100 Gelas Jus Jeruk** :

* Menggunakan **Python List murni** seperti mengupas satu jeruk, memerasnya, menuangkannya ke gelas, lalu mengulanginya dari awal satu per satu sebanyak 100 kali. Ini sangat melelahkan dan memakan waktu lama.
* Menggunakan **NumPy Array** seperti menggunakan **Mesin Industri Pemeras Jeruk Raksasa**.2 Anda memasukkan 100 jeruk ke dalam mesin sekaligus, menekan satu tombol, dan dalam satu detik mesin mengeluarkan 100 gelas jus jeruk secara bersamaan. Konsep ini disebut sebagai **Vektorisasi**.3

##### **Penjelasan Teori Rinci**

Python List bawaan sangat fleksibel karena dapat menyimpan berbagai tipe data campuran dalam satu tempat. Namun, fleksibilitas ini harus dibayar mahal. Secara internal, Python List hanyalah kumpulan penunjuk pointer alamat memori yang tersebar secara acak. Ketika melakukan operasi aritmatika pada List menggunakan perulangan, interpreter Python harus memeriksa tipe data setiap elemen satu per satu, mengonversinya, dan menghitungnya. Proses ini lambat dan tidak efisien untuk data skala besar.
NumPy (Numerical Python) memecahkan masalah performa ini dengan memperkenalkan struktur data ndarray (N-dimensional Array). Karakteristik arsitektural utama NumPy Array meliputi:
**Memori Kontigu Homogen**: Semua elemen di dalam NumPy Array wajib memiliki tipe data yang sama. Hal ini memungkinkan NumPy untuk menyimpan data secara berurutan tanpa jeda di dalam blok memori fisik komputer.
**Vektorisasi**: Memungkinkan kita mengeksekusi operasi matematika pada seluruh elemen array secara bersamaan tanpa memerlukan penulisan perulangan for di tingkat Python. Di balik layar, operasi ini dijalankan menggunakan instruksi kompilasi bahasa C tingkat rendah dan teknologi akselerasi prosesor modern.
Mari kita pelajari operasi matriks dasar yang merupakan pilar matematika kecerdasan buatan:
**Penjumlahan Matriks**: Menjumlahkan elemen-elemen yang berada di posisi indeks yang sama dari dua matriks yang memiliki dimensi yang sama persis.
**Perkalian Skalar**: Mengalikan setiap elemen individual di dalam matriks dengan satu nilai angka tunggal.
**Dot Product (Perkalian Matriks)**: Operasi baris kali kolom. Untuk mengalikan dua matriks  dan , jumlah kolom dari matriks pertama  wajib sama dengan jumlah baris dari matriks kedua .14 Operasi ini diimplementasikan menggunakan operator khusus @ atau fungsi np.dot().
**Transpose**: Memutar matriks sehingga baris menjadi kolom dan sebaliknya. Operasi ini ditulis sangat ringkas di NumPy menggunakan atribut .T.
...
\[ a21  a22  a23 \]           \[ b21  b22 \]                  \[ c21  c22 \]
                            \[ b31  b32 \]
Kalkulasi c11: (a \* b11) \+ (a \* b21) \+ (a \* b31)
...
* **Baris 1**: import numpy as np Mengimpor pustaka NumPy ke dalam program dan memberi alias np secara standar industri.
* **Baris 3**: m \= np.array(\[, \]) Membuat matriks NumPy pertama berdimensi  dari struktur List bersarang.
* **Baris 4**: m \= np.array(\[, \]) Membuat matriks NumPy kedua berdimensi .3
* **Baris 6**: hasil \= m @ m Mengeksekusi perkalian aljabar matriks (dot product) menggunakan operator khusus @.3 Nilai posisi indeks pertama dari matriks hasil dihitung dari .5
...
1. Penjumlahan elemen-demi-elemen pada matriks 3:
   ...
   *Penjelasan baris demi baris*:
   * **Baris 1**: a \=... mendefinisikan array satu dimensi pertama.
   * **Baris 2**: b \=... mendefinisikan array satu dimensi kedua.
   * **Baris 3**: c \= a \+ b menjumlahkan elemen pada posisi indeks yang bersesuaian secara paralel.
...
2. Mengalikan matriks dengan skalar 9:
   ...
   *Penjelasan baris demi baris*:
   * **Baris 1**: matriks \=... membuat matriks .3
   * **Baris 2**: skalar\_hasil \= matriks \* 3 mengalikan setiap elemen di dalam matriks dengan angka 3 secara serentak.
   * **Baris 3**: print(skalar\_hasil) mencetak \[, \].
3. Melakukan Transpose Matriks 3:
   ...
   *Penjelasan baris demi baris*:
   * **Baris 1**: original \=... membuat matriks berukuran .3
   * **Baris 2**: rotated \= original.T memutar matriks sehingga kolom menjadi baris menggunakan properti .T.
   * **Baris 3**: print(rotated) mencetak matriks hasil pemutaran berukuran .4

##### **3 Common Mistakes**

1. **Dimensi Tidak Cocok untuk Dot Product**: Mencoba mengalikan dua matriks dengan operator @ padahal kolom matriks pertama tidak sama dengan baris matriks kedua, misalnya mengalikan matriks  dengan matriks . Ini akan memicu ValueError: shapes not aligned.
2. **Mengasumsikan Bintang (\*) adalah Dot Product**: Menggunakan operator \* dan mengira itu melakukan perkalian aljabar matriks. Operator \* pada NumPy mengeksekusi perkalian elemen-demi-elemen (*Hadamard Product*), sedangkan @ mengeksekusi aljabar matriks dot product.
...
1. Selalu gunakan alias import numpy as np secara konsisten karena ini adalah konvensi universal sains data.
2. Lakukan inspeksi bentuk array menggunakan atribut .shape sebelum melakukan operasi aljabar linear kompleks untuk menghemat waktu debugging eror dimensi.
3. Manfaatkan operasi vektor bawaan NumPy secara maksimal, hindari penggunaan perulangan for biasa jika Anda bisa mengekspresikannya dalam bentuk operasi matriks NumPy langsung demi kecepatan performa.

##### **Hubungan Konsep Ini dengan AI/Data Science**

Operasi matriks adalah jantung komputasi kecerdasan buatan. Di dalam Jaringan Saraf Tiruan, input data direpresentasikan sebagai matriks , dan bobot sinapsis antar-neuron direpresentasikan sebagai matriks .3 Proses penyuapan data ke depan di setiap lapisan neuron pada dasarnya hanyalah operasi perkalian matriks diikuti penjumlahan bias: .3 Memahami NumPy adalah kunci utama untuk memahami bagaimana pustaka seperti PyTorch memproses model kecerdasan buatan.

##### **Latihan Kecil dengan Contoh Jawaban**

Buatlah dua matriks NumPy satu dimensi: x \= dan y \= . Hitung hasil perkalian dot product antara kedua array tersebut menggunakan fungsi np.dot(x, y). *Contoh Jawaban*:
...
Pustaka NumPy memperkenalkan struktur ndarray homogen berkinerja tinggi yang mendukung komputasi matriks aljabar linear berkecepatan tinggi melalui vektorisasi, menjadi fondasi utama kalkulasi model kecerdasan buatan modern.
...
Pandas adalah pustaka manipulasi data tabular yang dibangun di atas NumPy, menawarkan struktur DataFrame untuk mengelola tabel data lengkap dengan kolom berlabel dan pengindeksan baris yang fleksibel.

##### **Analogi**

Bayangkan Pandas sebagai aplikasi **Microsoft Excel di dalam Kode Python**.2 Jika NumPy adalah susunan angka mentah yang tidak memiliki label, maka Pandas DataFrame adalah lembar kerja Excel lengkap dengan nama kolom di bagian atas, dan nomor baris di bagian samping, membuat analisis data menjadi sangat intuitif.

##### **Penjelasan Teori Rinci**

Meskipun NumPy sangat cepat dan efisien untuk operasi matematika numerik, ia memiliki keterbatasan serius saat kita bekerja dengan dataset dunia nyata. Dataset riil biasanya heterogen (berisi campuran teks, tanggal, dan angka desimal) dan membutuhkan label deskriptif untuk kolom-kolomnya. NumPy Array tidak dirancang untuk menangani data heterogen semacam ini.
Pandas didesain khusus untuk mengatasi tantangan tersebut. Pandas memperkenalkan dua objek data utama:
**Series**: Struktur data satu dimensi yang menyerupai List atau array satu dimensi NumPy. Bedanya, Series memiliki indeks berlabel kustom yang bisa berupa string, bukan hanya nomor indeks integer saja.
**DataFrame**: Struktur data dua dimensi berbentuk tabel terstruktur. DataFrame pada dasarnya adalah kumpulan dari beberapa objek Series yang saling berbagi baris indeks yang sama. Setiap kolom di dalam DataFrame dapat memiliki tipe data yang berbeda.
Fungsi paling populer di Pandas untuk memulai analisis data adalah read\_csv(file\_path). Fungsi ini bertugas membaca dokumen bertipe CSV dari cakram keras, secara otomatis mendeteksi nama kolom dari baris pertama berkas, mengurai tipe data di setiap kolom, dan membangun objek DataFrame lengkap di dalam memori program.
Setelah data dimuat menjadi DataFrame, kita dapat melakukan berbagai operasi penting:

* Inspeksi Awal: Menggunakan .head(n) untuk mengintip  baris pertama data guna memahami strukturnya, atau .info() untuk melihat ringkasan tipe data dan jumlah baris yang tidak kosong.
...
1. Membaca file CSV eksternal 1:
   ...
   *Penjelasan baris demi baris*:
   * **Baris 1**: pd.read\_csv(...) digunakan untuk membaca file tabular CSV fisik di penyimpanan lokal menjadi objek DataFrame Pandas secara instan.
...
3. Mengakses kolom tertentu dan menghitung rata-ratanya :
   ...
   * **Baris 4**: print(mean\_loss) mencetak hasilnya.
...
3. Hindari penggunaan perulangan for untuk memodifikasi baris DataFrame secara manual; gunakan fungsi .apply() bersama ekspresi Lambda untuk pemrosesan kolom yang tervektorisasi dan jauh lebih cepat.

##### **Hubungan Konsep Ini dengan AI/Data Science**

Tahap terpenting dari proyek kecerdasan buatan bukanlah pembuatan model, melainkan persiapan data. Sekitar 70% waktu praktisi kecerdasan buatan dihabiskan untuk memeriksa data, membersihkan data yang rusak, membuang baris kosong, memilih fitur kolom yang relevan, dan memotong dataset menjadi porsi latih dan uji. Semua aktivitas pembersihan dan rekayasa fitur data tabular tersebut diimplementasikan menggunakan pustaka Pandas.
...
3. Ketika mengolah aliran data sensor (data streaming) berkapasitas gigabyte, mengapa penggunaan Generator berbasis yield lebih disarankan dibandingkan penulisan fungsi konvensional yang mengembalikan objek List besar? Evaluasi dari perspektif efisiensi penggunaan ruang memori RAM komputer.
...
1. Buat sebuah berkas data fisik bernama sensor\_data.txt menggunakan operasi File I/O. Tuliskan lima baris nilai loss numerik tiruan berikut di dalamnya: 0.95, 1.50, \-0.20, 0.45, 0.10.6
2. Buatlah sebuah fungsi generator bernama baca\_aliran\_data yang bertugas membuka berkas tersebut, melintasi baris-baris data secara malas (bertahap menggunakan yield), dan secara otomatis membuang spasi kosong atau karakter baris baru.
...
4. Buatlah fungsi kalkulator kustom bernama kalibrasi\_loss yang mengonsumsi data dari generator tersebut. Fungsi ini harus mengabaikan nilai loss negatif (di bawah 0.0) karena dianggap anomali sensor 4, dan mengalikan nilai loss positif dengan faktor skala kalibrasi sebesar 1.2.
...
* **Desain Aliran Data & Generator (Bobot 30%)**: Peserta secara konsisten mengimplementasikan manajer konteks with untuk membuka berkas secara aman 6 dan merancang fungsi generator menggunakan instruksi yield secara benar.
...
* **Kualitas Struktur & Gaya Penulisan (Bobot 15%)**: Kode ditulis dengan bersih, rapi, menerapkan gaya penamaan variabel yang deskriptif (*snake\_case*), serta menyertakan dokumentasi penjelas alur fungsi.
...
**Jawaban Benar**: **B** *Alasan*: Python disukai karena ia bertindak sebagai perekat atau bahasa kontrol. Proses komputasi matematika yang berat ditangani oleh pustaka berkinerja tinggi di tingkat bahasa C/C++, sementara Python memfasilitasi kemudahan penulisan instruksi di tingkat atas. *Alasan Opsi Salah*:
...
* *Opsi C salah* karena Python menggunakan manajemen memori otomatis berbasis pengumpul sampah, bukan manajemen memori manual.
* *Opsi D salah* karena kalkulasi matriks berat didelegasikan ke pustaka eksternal berbasis C++/CUDA untuk dieksekusi di GPU, bukan ditangani langsung oleh interpreter Python murni.
...
* *Opsi D salah* karena GitHub hanyalah repositori penyimpanan kode versi, bukan platform eksekusi lokal yang mengelola isolasi dependensi runtime komputer pengembang.
...
**Jawaban Benar**: **C** *Alasan*: Pembagian menggunakan operator / di Python akan selalu menghasilkan tipe data desimal Float, bahkan jika kedua operand adalah integer utuh. Pada contoh ini, 25.0 / 4 menghasilkan 6.25 yang bertipe Float. *Alasan Opsi Salah*:

* *Opsi A salah* karena hasil pembagian memiliki komponen desimal di belakang koma, sehingga tidak bisa direpresentasikan sebagai Integer utuh.
* *Opsi B salah* karena tidak ada proses konversi string atau representasi teks di dalam operasi matematika tersebut.
* *Opsi D salah* karena operasi aritmatika pembagian menghasilkan angka, bukan status logika kebenaran True/False.
...
**Jawaban Benar**: **A** *Alasan*: Kondisi pertama score \< 10 (15 \< 10) bernilai False. Kondisi kedua score % 3 \== 0 (15 % 3 \== 0 \-\> 0 \== 0) bernilai True. Operasi logika False or True menggunakan operator or akan mengevaluasi hasil akhir menjadi True. *Alasan Opsi Salah*:

* *Opsi B salah* karena operator or hanya membutuhkan salah satu kondisi bernilai benar untuk menghasilkan True.
...
**Jawaban Benar**: **B** *Alasan*: Fungsi print() hanyalah efek samping cetak keluaran ke layar untuk kebutuhan inspeksi manusia. Agar nilai hasil kalkulasi di dalam fungsi dapat disalurkan, diolah, atau disimpan ke dalam variabel di luar fungsi, pengembang wajib menggunakan kata kunci return. *Alasan Opsi Salah*:
...
* *Opsi D salah* karena penulisan return justru sangat direkomendasikan untuk fungsi-fungsi kalkulasi matematika di bidang AI.
...
* C. Mengembalikan satu nilai aktif keluar ke program utama, menjeda sementara eksekusi fungsi generator, dan mengingat seluruh status variabel internal untuk dilanjutkan nanti.
* D. Memicu pembagian beban kerja komputasi secara otomatis dari CPU ke core GPU.

**Jawaban Benar**: **C** *Alasan*: Berbeda dengan return yang mematikan fungsi, kata kunci yield pada generator berfungsi untuk merealisasikan evaluasi malas. Ia mengeluarkan satu nilai, membekukan state fungsi, dan siap melanjutkannya saat dipanggil kembali. *Alasan Opsi Salah*:

* *Opsi A salah* karena mengembalikan seluruh data sekaligus adalah karakteristik dari pernyataan return konvensional.
* *Opsi B salah* karena generator justru menghemat memori dengan tidak menciptakan list objek besar di awal, bukan bertindak sebagai penghapus memori paksa.
* *Opsi D salah* karena yield adalah bagian dari kontrol alur tingkat tinggi Python murni dan tidak mengurusi pembagian instruksi hardware ke GPU.
...
* B. Mewakili referensi ke instansi objek aktif yang sedang dibuat di memori, memungkinkan pengikatan atribut spesifik ke objek tersebut.
...
**Jawaban Benar**: **B** *Alasan*: Parameter self wajib ditulis sebagai parameter pertama setiap metode dalam kelas. self bertindak sebagai penunjuk referensi ke objek fisik yang sedang memanggil metode tersebut, sehingga atribut individual objek dapat diatur secara terisolasi. *Alasan Opsi Salah*:

* *Opsi A salah* karena self tidak ada hubungannya dengan modul impor eksternal program.
* *Opsi C salah* karena penghapusan objek ditangani oleh pengumpul sampah otomatis Python atau metode dunder destructor \_\_del\_\_, bukan oleh parameter self.
* *Opsi D salah* karena konversi representasi string ditangani oleh metode dunder \_\_str\_\_ atau \_\_repr\_\_.7

### **Soal 10**

Diberikan dua matriks NumPy berdimensi  sebagai berikut:
...
* Elemen :  14
* Elemen :  14
* Elemen :  14 Sehingga hasilnya adalah \[, \]. *Alasan Opsi Salah*:
* *Opsi A salah* karena \[, \] adalah hasil dari perkalian elemen-demi-elemen (A \* B), bukan aljabar matriks dot product.
* *Opsi C salah* karena itu adalah hasil penjumlahan biasa A \+ B.
...
"Ekosistem kecerdasan buatan modern berhasil menjembatani jurang pemisah antara kemudahan penulisan kode Python dengan kecepatan eksekusi mesin melalui pendekatan arsitektur hibrida. Pustaka kecerdasan buatan populer seperti NumPy dan PyTorch tidak menjalankan perhitungan matematis beratnya di tingkat interpreter Python murni. Sebaliknya, mereka bertindak sebagai bahasa kontrol. Di balik layar, seluruh komputasi intensif aljabar linear, perkalian matriks, dan kalkulasi gradien ditulis menggunakan bahasa C++ dan CUDA yang dikompilasi secara optimal untuk dijalankan langsung di atas CPU atau GPU. Dengan demikian, pengembang mendapatkan yang terbaik dari kedua dunia: kemudahan menulis instruksi tingkat tinggi dengan sintaksis Python yang bersih, sekaligus performa eksekusi tingkat rendah yang setara dengan C++.1
...
Peserta akan membangun prototipe sistem pemrosesan awal dataset teks otomatis untuk asisten kecerdasan buatan. Sistem ini harus mampu mensimulasikan pembacaan file dataset ulasan mentah, menyaring baris data kosong atau rusak secara aman, mengklasifikasikan kategori berdasarkan aturan logika sederhana, serta melakukan analisis statistik frekuensi menggunakan Pandas DataFrame.

### **Langkah Pengerjaan**

1. **Tahap Penyiapan Data**: Buatlah file dataset fisik bernama ulasan\_mentah.txt menggunakan File I/O. Masukkan beberapa ulasan ulasan dengan format teks\_ulasan;sentimen\_label di mana ada baris yang sengaja dirusak (kosong atau salah pemisah).
2. **Tahap OOP**: Buat sebuah Class bernama DokumenUlasan yang menyimpan data instansi teks\_asli dan kategori.
3. **Tahap Pembersihan**: Susun fungsi generator aliran\_pembersih yang membaca file tersebut secara bertahap. Di dalam generator, terapkan penanganan kesalahan try-except untuk memotong teks, mengubah ke huruf kecil, menghapus spasi berlebih, serta memfilter baris kosong agar program tidak crash.
...
| :---- | :---- | :---- |
| **Penerapan OOP Dasar** | Ketepatan pendeklarasian Class, penyusunan atribut instansi, serta pemanggilan fungsi metode kelas. | 20% |
...
| **Operasi File I/O & Generator** | Penulisan kode pembacaan file dengan manajer konteks with dan efisiensi memori berbasis yield. | 20% |
...
| **Kerapian & Struktur Kode** | Konsistensi penulisan indentasi, penamaan variabel (PEP 8), dan kebersihan log terminal. | 15% |

## **Catatan untuk Developer**

### **Bagian yang Cocok Jadi Materi Teori Naratif**

* **Topik 1: Memulai Python** (Chapter Apa Itu Python) dan bagian pengantar **Fase 1 s/d Fase 5** sangat baik disajikan dalam format teks bacaan naratif interaktif di platform karena kaya akan analogi sehari-hari.
* **Penjelasan Teori Rinci** pada setiap chapter yang membahas struktur alokasi memori objek Python dan aljabar matriks NumPy disarankan menggunakan ilustrasi grafis statis pendukung di halaman website platform.
...
* **Kuis Evaluasi Komprehensif (Soal 1 s/d Soal 10)** sangat ideal disajikan sebagai kuis pilihan ganda interaktif di akhir setiap fase pembelajaran untuk memverifikasi pemahaman teoretis peserta secara cepat.

### **Bagian yang Cocok Jadi Diskusi Kelompok**

* **Prompt Diskusi Utama** mengenai perbandingan efisiensi Python vs C++ sangat disarankan disajikan pada forum diskusi terbuka antar-peserta di platform untuk melatih pemikiran kritis.

...
| 04 - Reasoning | Aktif final baru, 5 chapter + visual flow/quick check + panel sumber utuh `Reasoning-baru.md` | Aktif final, sumber latihan/proyek akhir utuh + 6 skenario save/edit/reset | Aktif final, sumber kuis utuh + 15 soal full-card clickable single attempt | Aktif final, sumber diskusi utuh + prompt/thread lokal | `ai-reasoning.js` + `04-reasoning/chapters/*-full.html` | Folder canonical `04-reasoning/`; route activity final `#/participant-ai-reasoning-practice`, `#/participant-ai-reasoning-quiz`, `#/participant-ai-reasoning-discussion`; konten sumber tidak dikompres dan bukan scaffold placeholder |

...
**Wajib baca untuk AI agent baru.**

## Order Membaca

1. **`AGENTS.md`** (root project) — Design rules HerAI
2. **`GEMINI.md`** (root project) — Platform guidelines
3. **`handover/HANDOVER_UPDATE.md`** — Final state Reasoning module
4. **`handover/REASONING_RULES_AND_PATTERNS.md`** — All CSS/JS/pipeline rules
